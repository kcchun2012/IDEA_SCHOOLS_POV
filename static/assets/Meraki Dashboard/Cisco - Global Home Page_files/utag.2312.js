//tealium universal tag - utag.2312 ut4.0.201709011316, Copyright 2017 Tealium.com Inc. All Rights Reserved.
var _elqQ=_elqQ||[];try{(function(id,loader,u){try{u=utag.o[loader].sender[id]={}}catch(e){u=utag.sender[id]};u.ev={'view':1};u.qsp_delim='&';u.kvp_delim='=';u.elqSetSiteId="2026391005,177775138,983166544";u.base_url="//img.en25.com/i/elqCfg.min.js";u.map={};u.extend=[function(a,b){try{if(b['dom.url'].toString().indexOf('?value=high')>-1){b['page.pageInfo.value']='high'}}catch(e){utag.DB(e)}},function(a,b){try{if(1){function addLoadEvent(func){var oldonload=window.onload;if(typeof window.onload!='function'){window.onload=func;}else{window.onload=function(){if(oldonload){oldonload();}
func();};}}
...
try{utag.o[loader].loader.LOAD(id)}catch(e){utag.loader.LOAD(id)}})('2312','cisco.cdc');}catch(e){}
