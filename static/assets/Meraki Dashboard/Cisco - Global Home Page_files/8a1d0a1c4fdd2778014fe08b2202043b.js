/* Pushed : Fri, 26 Jan 2018 7:17 PM UTC */
...
var scriptTag = document.scripts[document.scripts.length - 1];var pt_ff8081816000bbf201600337b41710fe = scriptTag.parentNode;
if(zQStringValue('zBase')){window['pt_'+zQStringValue('zBase')]=pt_ff8081816000bbf201600337b41710fe;}

try{
if (document.getElementById('ff8081816000bbf201600337b41710fe')) { 
	pt_ff8081816000bbf201600337b41710fe = document.getElementById('ff8081816000bbf201600337b41710fe'); 
}
} catch (err) {}

/*adding key variables */
var zBaseUrl = 'http://widgets.ziftsolutions.com/cisco.ziftsolutions.com/js/ff8081816000bbf201600337b41710fe';
var zBaseKey = 'cisco.ziftsolutions.com/js/';
var zStandaloneBaseUrl = 'http://sites.ziftsolutions.com/cisco.ziftsolutions.com/ff8081816000bbf201600337b41710fe';
...
if (!zLoaded) {
try {
zPanele0008 = new zwPanel('zPage','zFormId',"zFormValidation(this.getForm())",'ziftc','zSubmissionRefId','zift.trackback', 'http://sites.ziftsolutions.com/cisco.ziftsolutions.com/ff8081816000bbf201600337b41710fe', 'zPanele0008');
...
pt_ff8081816000bbf201600337b41710fe.appendChild(zScriptInclude(zBaseUrl + (zPage?'/'+zPage:'')));
}
function zWriteElementInclude(el) {
pt_ff8081816000bbf201600337b41710fe.appendChild(el);
}


/*processing dynamic step rules and routing */
var ztrack_ff8081816000bbf201600337b41710fe;if (typeof(zBase) == 'undefined' || zBase == null || zBase == 'null' || (zBase != null && zBaseComplete)) {addZiftLoadEvent(function() { ztrack_ff8081816000bbf201600337b41710fe = new ZTrack({ h: 'https://analytics.ziftsolutions.com/', i: (zBase?zBase:'ff8081816000bbf201600337b41710fe'), p: '8a1d0a1c4fdd2778014fe08b68f1043f', c: '8a12350747c4c06e0147c691962f772a', t: 't'} );}); zTS = 'https://cisco.ziftsolutions.com/';}
...
var s_5031 = document.createElement('div');s_5031.style.height = '0';s_5031.className = 'z_panel_base z_p_Tracking z_ps_Default';s_5031.id = 'pw_ff8081816000bbf201600337b41710fe';s_5031.style.display = 'none';pt_ff8081816000bbf201600337b41710fe.appendChild(s_5031);
s_5031.innerHTML = zContent.content;
var s_5334 = document.createElement('span');pt_ff8081816000bbf201600337b41710fe.appendChild(s_5334);
}
function zGetNextPageInternal(param, link) {
return '8a9e43b148006f48014800743567000a';
}
